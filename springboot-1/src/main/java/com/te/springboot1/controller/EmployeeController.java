...
public class EmployeeController {
	...
	//@Autowired(required=true)                         //ServiceImpl lona @Service ni comment chesinapudu server lona errors vastae
	@Autowired(required=false)                          //ServiceImpl lona @Service ni comment chesina kuda server lona atuvanti errors ravu
	...
	@PostMapping(path = "/add", produces = { MediaType.APPLICATION_JSON_VALUE,MediaType.APPLICATION_XML_VALUE }, consumes = { MediaType.APPLICATION_JSON_VALUE,
	...
	@PutMapping(path = "/update", produces = { MediaType.APPLICATION_JSON_VALUE,MediaType.APPLICATION_XML_VALUE }, consumes = { MediaType.APPLICATION_JSON_VALUE,
					MediaType.APPLICATION_XML_VALUE })
